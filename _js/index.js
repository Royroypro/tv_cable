jQuery(document).ready(function(){
  ...
  scanner.addListener('scan', function (content) {
    ...
    sonido.play();
    // Redirige al usuario a guardar_lectura.php con el contenido del QR como parámetro
  window.location.href = "guardar_lectura.php?lectura=" + encodeURIComponent(content);
